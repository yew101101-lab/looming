      ...
      <div className="quality-cards">
        <div className="quality-card animate-on-scroll card-1">
          <div className="card-img-wrapper">
            <img src={`${import.meta.env.BASE_URL}quality_wax.png`} alt="프리미엄 왁스" className="card-img" />
          </div>
          <h3>프리미엄 왁스</h3>
        ...
        <div className="quality-card animate-on-scroll card-2">
          <div className="card-img-wrapper">
            <img src={`${import.meta.env.BASE_URL}quality_scent.png`} alt="시그니처 향" className="card-img" />
          </div>
          <h3>시그니처 향</h3>
        ...
        <div className="quality-card animate-on-scroll card-3">
          <div className="card-img-wrapper">
            <img src={`${import.meta.env.BASE_URL}quality_package.png`} alt="정성스러운 패키지" className="card-img" />
          </div>
          <h3>정성스러운 패키지</h3>
